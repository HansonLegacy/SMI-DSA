...
# 固定五帧插值位置
T_LIST = [Fraction(1, 6), Fraction(2, 6), Fraction(3, 6), Fraction(4, 6), Fraction(5, 6)]  # [Fraction(1, 6), Fraction(2, 6), Fraction(3, 6), Fraction(4, 6), Fraction(5, 6)]
# T_LIST = [Fraction(1, 4), Fraction(2, 4), Fraction(3, 4)]  # 这是插3帧
GT_NAME = {Fraction(1, 6): "frame_2_gt.png", Fraction(2, 6): "frame_3_gt.png", Fraction(3, 6): "frame_4_gt.png", Fraction(4, 6): "frame_5_gt.png", Fraction(5, 6): "frame_6_gt.png"}  # GT_NAME = {Fraction(1, 6): "frame_2_gt.png", Fraction(2, 6): "frame_3_gt.png", Fraction(3, 6): "frame_4_gt.png", Fraction(4, 6): "frame_5_gt.png", Fraction(5, 6): "frame_6_gt.png"}
# GT_NAME = {Fraction(1, 4): "frame_2_gt.png", Fraction(2, 4): "frame_3_gt.png", Fraction(3, 4): "frame_4_gt.png"}

@register("xiehe_5_datasplit")
class XHTrans5Frame(Dataset):
    """
    协和脑血管插5帧数据集：
    每个样本目录包含 frame_1.png / frame_7.png / frame_2_gt.png / frame_3_gt.png / frame_4_gt.png / frame_5_gt.png / frame_6_gt.png
    训练样本展开为 5 个 item：(t=1/6, 2/6, 3/6, 4/6, 5/6)
    """
    def __init__(self, root_path, patch_size=(224, 224), split="train", val_test_patch_mode="resize", **kwargs):
        super(XHTrans5Frame, self).__init__()
        ...
        # 过滤：必须包含所有需要的文件
        valid = []
        need = ["frame_1.png", "frame_7.png", "frame_2_gt.png", "frame_3_gt.png", "frame_4_gt.png", "frame_5_gt.png", "frame_6_gt.png"]  # need = ["frame_1.png", "frame_7.png", "frame_2_gt.png", "frame_3_gt.png", "frame_4_gt.png", "frame_5_gt.png", "frame_6_gt.png"]
        # need = ["frame_1.png", "frame_5.png", "frame_2_gt.png", "frame_3_gt.png", "frame_4_gt.png"]
    ...
    def get_img(self, index):
        ...
        img1 = read_image(os.path.join(d, "frame_7.png"))
    ...
    def __getitem__(self, item):
        ...
        if self.mode == "train":
            ...
            elif self.val_test_patch_mode == "match_train":
                img0 = pad_img_to_square_1024(img0)
                imgt = pad_img_to_square_1024(imgt)
                img1 = pad_img_to_square_1024(img1)

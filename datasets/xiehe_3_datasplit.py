...
# 固定三帧插值位置
T_LIST = [0.25, 0.50, 0.75]  # T_LIST = [0.25, 0.50, 0.75]
# T_LIST = [0.25]
GT_NAME = {0.25: "frame_2_gt.png", 0.50: "frame_3_gt.png", 0.75: "frame_4_gt.png"}  # GT_NAME = {0.25: "frame_2_gt.png", 0.50: "frame_3_gt.png", 0.75: "frame_4_gt.png"}
# GT_NAME = {0.25: "frame_2_gt.png"}

@register("xiehe_3_datasplit")
class XHTrans3Frame(Dataset):
    """
    协和脑血管插3帧数据集：
    每个样本目录包含 frame_1.png / frame_5.png / frame_2_gt.png / frame_3_gt.png / frame_4_gt.png
    训练样本展开为 3 个 item：(t=0.25,0.5,0.75)
    """
    def __init__(self, root_path, patch_size=(224, 224), split="train", **kwargs):
        super(XHTrans3Frame, self).__init__()
        ...
        # 过滤：必须包含所有需要的文件
        valid = []
        need = ["frame_1.png", "frame_5.png", "frame_2_gt.png", "frame_3_gt.png", "frame_4_gt.png"]  # need = ["frame_1.png", "frame_5.png", "frame_2_gt.png", "frame_3_gt.png", "frame_4_gt.png"]
        # need = ["frame_1.png", "frame_5.png", "frame_2_gt.png"]
        for d in dirs:
    ...
    def get_img(self, index):
        ...
        img1 = read_image(os.path.join(d, "frame_5.png"))

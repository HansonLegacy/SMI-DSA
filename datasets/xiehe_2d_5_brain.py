...
# 固定五帧插值位置（frame_1 与 frame_7 之间等距插5帧）
T_LIST = [1/6, 2/6, 3/6, 4/6, 5/6]  # T_LIST = [1/6, 2/6, 3/6, 4/6, 5/6]
# T_LIST = [1/6]
...
GT_NAME = {
    ...
    4/6: "frame_5_gt.png",
    5/6: "frame_6_gt.png",
}  # GT_NAME = {1/6: "frame_2_gt.png", 2/6: "frame_3_gt.png", 3/6: "frame_4_gt.png", 4/6: "frame_5_gt.png", 5/6: "frame_6_gt.png"}
# GT_NAME = {1/6: "frame_2_gt.png"}


@register("xiehe_2d_5_brain")
class XHTrans5Frame(Dataset):
    ...
    def __init__(self, root_path, patch_size=(224, 224), split="train", **kwargs):
        ...
        need = [
            ...
            "frame_5_gt.png",
            "frame_6_gt.png",
        ]  # need = ["frame_1.png", "frame_7.png", "frame_2_gt.png", "frame_3_gt.png", "frame_4_gt.png", "frame_5_gt.png", "frame_6_gt.png"]
        # need = ["frame_1.png", "frame_7.png", "frame_2_gt.png"]
        for d in dirs:
